...
public class DataSourceService : IDataSourceService
{
    ...
    private async Task<Domain.Entities.DataSource> GetOwnedDataSourceOrThrow(
        ...
        CreateDataSourceCommand command, CancellationToken cancellationToken = default)
    {
        ...
        // Encrypt regardless of outcome — the user may fix credentials and retest later,
        // and we never want a plaintext connection string touching the database at all.
