...
public interface INotificationRepository
{
    ...
    Task<(IReadOnlyList<Notification> Items, int TotalCount)> GetPagedAsync(Guid organizationId, int page, int pageSize, DateTime? dateFrom, DateTime? dateTo, CancellationToken cancellationToken = default);
